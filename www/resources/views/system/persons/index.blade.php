...
@section('content')
    <div class="card crud-persons">
        <div class="card-header d-flex p-1">
            <h5 class="fs-sm mb-0 px-1">
                <i class="ph-keyboard"></i> Pessoas
            </h5>
        </div>
        <div class="card-body p-0 m-0 bg-silver">
            @include('system.persons.components.main_menu')
            ...
            @include('system.persons.components.datatable')
...
@section('js-files')
    <script type="text/javascript" src="{{ asset('assets/js/custom/system/persons/index.js') }}?v={{ time() }}"></script>
    <script type="text/javascript" src="{{ asset('assets/js/custom/system/persons/form-common.js') }}?v={{ time() }}"></script>
@endsection
