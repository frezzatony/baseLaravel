            ...
            <div class="tab-content flex-lg-fill">
                <div class="tab-pane fade active show" id="tab-module-cadastro" role="tabpanel">
                    <ul class="nav nav-tabs nav-tabs-highlight">
                        <li class="nav-item"><a href="tab-module-cadatro-usuario" class="nav-link fs-sm p-1 m-0 active">Usuário</a></li>
                    </ul>
                    <div class="tab-content flex-lg-fill">
                        <div class="tab-pane fade border-start border-end border-bottom active show" id="tab-module-cadatro-usuario" role="tabpanel">
                            <div class="col-md-24 p-2 bg-white border">
                                @include('system.users.edit.cadastro_usuario')
                            </div>
                        </div>
                    </div>
                </div>
