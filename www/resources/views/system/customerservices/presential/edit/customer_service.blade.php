...
<div class="row p-0 m-0 mb-1">
    ...
    <div class="col-sm-10 col-md-10 py-0 px-1">
        <label for="show_handling_time" class="form-label fw-semibold fs-sm m-0">Tempo em atendimento</label>
        <input type="text" id="show_handling_time" name="show_handling_time" class="form-control px-1 pt1 pb1 fs-sm" value="" readonly>
    </div>
</div>
