    ...
    <form id="form-holiday" autcomplete="off">
        ...
        <div class="row m-0 mt-3">
            ...
            <div class="col-sm-6 px-1">
                <input type="text" id="show_item_id" class="form-control px-1 pt1 pb1 fs-sm" value="{{ $holiday->id }}" readonly>
            </div>
        </div>
        <div class="row m-0">
            <div class="col-md-5 d-flex justify-content-end px-0 py-1 m-0">
            ...
            <div class="col-sm-18 px-1">
                <input type="text" id="description" name="description" class="form-control px-1 pt1 pb1 fs-sm uppercase" value="{{ $holiday->description }}">
            </div>
        </div>
        <div class="row m-0">
            <div class="col-md-5 d-flex justify-content-end px-0 py-1 m-0">
            ...
            <div class="col-sm-18 p-0 m-0 ">
                <span class="d-inline-block pa1">
                    &nbsp;<input type="checkbox" id="annual" name="annual" value="t" {!! $holiday->annual ? 'checked' : '' !!}>
                </span>
        ...
        <div class="row m-0">
            ...
            <div class="col-sm-18 px-1">
                <input type="date" id="date" name="date" class="form-control col-md-10 px-1 pt1 pb1 fs-sm" value="{{ $holiday->date }}">
            </div>
        </div>
        <div class="row m-0">
            <div class="col-md-5 d-flex justify-content-end px-0 py-1 m-0">
            ...
            <div class="col-sm-18 px-1">
                <select name="type" id="type" class="form-select col-md-10 px-1 pt1 pb1 fs-sm">
                    @foreach (\App\Enums\HolidayType::asArray() as $key => $holidayType)
                        <option value="{{ $key }}" {{ $holiday->type == $key ? 'selected' : '' }}>{{ $holidayType }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="row m-0">
            ...
            <div class="col-sm-18 p-0 m-0">
                <div class="d-inline-block pa1">
                    &nbsp;<input type="checkbox" id="optional" name="optional" value="t" {!! $holiday->optional ? 'checked' : '' !!}>
                </div>
            </div>
        </div>
        <div class="row m-0">
            ...
            <div class="col-sm-8 px-1">
                <input type="time" id="time_start" name="time_start" class="form-control px-1 pt1 pb1 fs-sm" value="{{ $holiday->time_start }}">
            </div>
        </div>
        <div class="row m-0">
            <div class="col-md-5 d-flex justify-content-end px-0 py-1 m-0">
            ...
            <div class="col-sm-8 px-1">
                <input type="time" id="time_end" name="time_end" class="form-control px-1 pt1 pb1 fs-sm" value="{{ $holiday->time_end }}">
            </div>
        </div>
    </form>
@endsection
