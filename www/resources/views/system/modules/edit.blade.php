                            ...
                            <div class="col-md-24 p-2 bg-white">
                                <div class="row p-0 m-0 mb-1">
                                    <div class="col-md-4 py-0 px-1">
                                        ...
                                        <input type="text" name="show_item_id" class="form-control px-1 pt1 pb1 fs-sm" value="{{ $module->id }}" readonly>
                                    </div>
                                    <div class="col-md-5 py-0 px-1">
                                        ...
                                        <select id="is_active" name="is_active" class="form-select px-1 pt1 pb1 fs-sm">
                                            <option value="t" {{ $module->is_active ? 'selected' : '' }}>SIM</option>
                                            <option value="f" {{ !$module->is_active ? 'selected' : '' }}>NÃO</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row p-0 m-0 mb-1">
                                    <div class="col-md-12 py-0 px-1">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control px-1 pt1 pb1 fs-sm uppercase" value="{{ $module->name }}">
                                    </div>
                                    <div class="col-md-7 py-0 px-1">
                                        <label class="form-label fw-semibold fs-sm m-0">Slug:</label>
                                        <input type="text" id="slug" name="slug" class="form-control px-1 pt1 pb1 fs-sm lowercase" value="{{ $module->slug }}">
                                    </div>
                                </div>
                            </div>
                        </div>
